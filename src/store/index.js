...
import {appRouters, otherRouter} from '../router/routers'
...
const store = new Vuex.Store({
  ...
  mutations: {
    ...
    decodeToken: (state, token) => {
      ...
      state.userid = localStorage.token.split('.')[0]
      state.expire = new Date(3575639156968)
      state.username = localStorage.token.split('.')[1]
    },
